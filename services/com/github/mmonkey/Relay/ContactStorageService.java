...
public class ContactStorageService extends StorageService {
	...
	protected static final String CONTACT_USERNAME = "username";
	protected static final String CONTACT_ACCEPT_TERMS = "acceptTerms";
	protected static final String CONTACT_METHODS = "methods";
	protected static final String CONTACT_BLACKLIST = "blacklist";
	
	protected static final String CONTACT_METHOD_TYPE = "type";
	protected static final String CONTACT_METHOD_ADDRESS = "address";
	protected static final String CONTACT_METHOD_CARRIER = "carrier";
	protected static final String CONTACT_METHOD_ACTIVATION_KEY = "activationKey";
	protected static final String CONTACT_METHOD_IS_ACTIVATED = "isActivated";
	...
	protected void saveContact(Player player, Contact contact) {
	...
	protected List<String> getContactMethodList(Player player) {
	...
	protected List<ContactMethod> getMethods(CommentedConfigurationNode config) {
	...
	protected ContactMethod getContactMethod(Player player, String contactMethod) {
	...
	protected Contact getContact(String playerName) {
	...
	protected Contact getContact(UUID uniqueId) {
	...
	protected boolean deleteContactMethod(Player player, String name) {
	...
	protected boolean deleteContact(Player player) {
	...
	protected ContactStorageService(Relay plugin, File configDir) {
