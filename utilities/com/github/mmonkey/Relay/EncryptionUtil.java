...
public class EncryptionUtil {
	...
	protected String encrypt(String plainText) throws GeneralSecurityException, UnsupportedEncodingException {
	...
	protected String decrypt(String encryptedText) throws GeneralSecurityException, UnsupportedEncodingException {
	...
	protected static String generateSecretKey(int length) {
	...
	protected EncryptionUtil(String secretKey) {
