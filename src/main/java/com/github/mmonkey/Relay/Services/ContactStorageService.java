...
public class ContactStorageService extends StorageService {
	...
	public void saveBlacklist(CommentedConfigurationNode config, Contact contact) {
	...
	public List<ContactMethod> getMethods(CommentedConfigurationNode config) {
	...
	public List<UUID> getBlacklist(CommentedConfigurationNode config) {
