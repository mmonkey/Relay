...
public class ActivationMessageRelayService {
     ...
     *
     * @param method  ContactMethod
     * @param message String
     * @return MessageRelayResult
     */
    public MessageRelayResult sendActivationMessage(ContactMethod method, String message) {
     ...
     * @return MessageRelayResult
     */
    public MessageRelayResult sendActivationMessage(ContactMethod method, String text, String email) {
